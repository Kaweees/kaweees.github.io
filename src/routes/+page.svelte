  ...
  <div class="flex flex-col w-full m-0 p-0">
    ...
    >
      <p class="text-sm md:text-lg prose-xl my-3">
        I’m an engineer & entrepreneur focusing on applied robotics & embedded
        systems. I’m also currently researching Large Language Models and
        building AI projects in stealth. I also
        <Link href="/blog/" text="write" /> occasionally about philosophy and computers.
      </p>
      <p class="text-sm md:text-lg prose-xl my-3">
        I’m a sophomore at <Link
          href="https://csc.calpoly.edu/"
          text="Cal Poly"
        />
        studying Computer Engineering. I am currently writing drivers and firmware
        for electric vehicles at <Link
      ...
      <p>
        ...
        their products, from the modular down to the transistor level.
      </p>
      <p>
    ...
    >
      <div
        class="my-3 border-b border-dashed border-fg-light dark:border-fg-dark"
      >
        {#if !jobs.length}
          <p>No jobs found.</p>
        {:else}
