...
<BorderedCard border={false}>
  <div class="border-b-2 border-dashed border-bg1-dark dark:border-bg1-light">
    <div class="">
      <div>
        <Title {title} {subtitle} {h2} />
        {#if currentURL == "/blog"}
          <p class="my-2 text-md">
            This is an archive of my journey to explore and conquer the inner
            workings of computers, from the subatomic particles in transistors
            to the cool stuff we do with processors, operating systems, and web
            browsers. Occasionaly, I’ll also give my two cents on philosophy.
  ...
  {:else}
    <ul>
      {#each currentPosts as post}
        <li
          class="py-5 border-b-2 border-dashed border-bg1-dark dark:border-bg1-light"
        >
          <article>
            <div
