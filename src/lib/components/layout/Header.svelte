...
<header class="flex items-center justify-between py-4 px-7 bg-bg1-light dark:bg-bg1-dark">
	<a
	...
	>
		<Typewriter
			...
			class="after:bg-title_secondary-light after:dark:bg-title_secondary-dark"
			cursorClassName="after:bg-title_secondary-light after:dark:bg-title_secondary-dark"
		>
			<span class="text-title_primary-light dark:text-title_primary-dark">&gt; Miguel</span>
			<span class="text-title_secondary-light dark:text-title_secondary-dark">VF</span>
		</Typewriter>
	</a>
